...
System.Console.WriteLine($"{Temperature.FtoC(72):F2}");
System.Console.WriteLine($"{Temperature.CtoF(22):F2}");
...
System.Console.WriteLine($"{Temperature.IsRoomTemp(22)}");
System.Console.WriteLine($"{Temperature.IsRoomTemp(17)}");
